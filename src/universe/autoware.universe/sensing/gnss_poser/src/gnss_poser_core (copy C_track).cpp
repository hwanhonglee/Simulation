  ...
  const sensor_msgs::msg::NavSatFix::ConstSharedPtr nav_sat_fix_msg_ptr)
{
  ...
  // HH_240920 Default CARLA offset
  gnss_base_pose_cov_msg.pose.pose = gnss_base_pose_msg.pose;

  // HH_240920 C_track offset
  gnss_base_pose_cov_msg.pose.pose.position.x = gnss_base_pose_msg.pose.position.x - 360958.0290674143;
  gnss_base_pose_cov_msg.pose.pose.position.y = gnss_base_pose_msg.pose.position.y - 4065983.3962770817; 
