...
private:
  ...
  double prev_yaw_deviation_;
  double prev_lateral_deviation_;
  rclcpp::Publisher<tier4_debug_msgs::msg::Float64Stamped>::SharedPtr deviation_yaw_dot_publisher_;
  rclcpp::Publisher<tier4_debug_msgs::msg::Float64Stamped>::SharedPtr deviation_lateral_dot_publisher_;
  rclcpp::Publisher<tier4_debug_msgs::msg::Float64Stamped>::SharedPtr yaw_rate_desire_publisher_;
  rclcpp::Publisher<tier4_debug_msgs::msg::Float64Stamped>::SharedPtr curvature_publisher_;  
  double calculateCurvature(const geometry_msgs::msg::Point& prev, const geometry_msgs::msg::Point& current, const geometry_msgs::msg::Point& next);
