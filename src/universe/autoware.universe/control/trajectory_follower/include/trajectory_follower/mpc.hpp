...
private:
  ...
  //HJ_231207
  // double lateral_position_dob;
  // Eigen::MatrixXd Wd_hat;
  // Eigen::MatrixXd Wd_hat_k;
  // Eigen::MatrixXd Wd_hat_pre;
  // Eigen::MatrixXd Wd_hat_dot;
  //HJ_231213
  double x1_dob_pre = 0.0;
  double x2_dob_pre = 0.0;
  double x3_dob_pre = 0.0;
  double u_dob_pre = 0.0;
