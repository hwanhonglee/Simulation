...
private:
  ...
  //HH_231205
  // matrix parameter
  rclcpp::Subscription<std_msgs::msg::Float64MultiArray>::SharedPtr wd_hat_sub_;
  rclcpp::Publisher<std_msgs::msg::Float64MultiArray>::SharedPtr wd_hat_pub_;
  void sub_disturbance_term(const std_msgs::msg::Float64MultiArray::SharedPtr msg);
