...
// MpcLateralController::MpcLateralController(rclcpp::Node & node)
{
  ...
  if (vehicle_model_type == "kinematics") {
    vehicle_model_ptr = std::make_shared<trajectory_follower::KinematicsBicycleModel>(
      wheelbase, m_mpc.m_steer_lim, m_mpc.m_param.steer_tau, m_wd_1, m_wd_2, m_wd_3); //HH_231205
  } else if (vehicle_model_type == "kinematics_no_delay") {
    vehicle_model_ptr = std::make_shared<trajectory_follower::KinematicsBicycleModelNoDelay>(
      wheelbase, m_mpc.m_steer_lim);
  } else if (vehicle_model_type == "dynamics") {
  ...
  //HH_231205 for sub topic 
  wd_hat_sub_ = node_->create_subscription<std_msgs::msg::Float64MultiArray>(
    "/Estimated_disturbance_term", 10, 
    std::bind(&MpcLateralController::sub_disturbance_term, this, std::placeholders::_1));  
  //HH_231205 for pub topic
  wd_hat_pub_ = node_->create_publisher<std_msgs::msg::Float64MultiArray>(
    "/hhhhhhhhhhhhhh", 10);
...
//HH_231205
void MpcLateralController::sub_disturbance_term(const std_msgs::msg::Float64MultiArray::SharedPtr msg)
{
    std::cout << "DOB Run!!!!" << std::endl << std::endl << std::endl << std::endl << std::endl << std::endl << std::endl << std::endl << std::endl << std::endl << std::endl << std::endl << std::endl << std::endl << std::endl << std::endl << std::endl << std::endl << std::endl << std::endl << std::endl << std::endl << std::endl << std::endl << std::endl << std::endl << std::endl << std::endl << std::endl << std::endl << std::endl << std::endl << std::endl << std::endl << std::endl << std::endl << std::endl << std::endl << std::endl << std::endl << std::endl << std::endl << std::endl << std::endl << std::endl << std::endl << std::endl << std::endl << std::endl << std::endl << std::endl << std::endl << std::endl << std::endl << std::endl << std::endl << std::endl << std::endl << std::endl << std::endl << std::endl << std::endl;

    m_wd_1 = msg->data[0];
    m_wd_2 = msg->data[1];
    m_wd_3 = msg->data[2];

    auto wd_hat = std_msgs::msg::Float64MultiArray();
    wd_hat.data = {m_wd_1, m_wd_2, m_wd_3};
    wd_hat_pub_->publish(wd_hat);    
}
