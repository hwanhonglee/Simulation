...
: Node("tensorrt_yolox", node_options)
{
  ...
  std::string model_path = declare_parameter("model_path", "/home/a/carla-autoware-universe/autoware/src/universe/autoware.universe/perception/tensorrt_yolox/data");
  std::string label_path = declare_parameter("label_path", "/home/a/carla-autoware-universe/autoware/src/universe/autoware.universe/perception/tensorrt_yolox/data");
