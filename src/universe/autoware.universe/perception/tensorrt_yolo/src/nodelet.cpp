...
: Node("tensorrt_yolo", options)
{
  ...
  // HH_241107
  std::string onnx_file = declare_parameter("onnx_file", "/home/a/carla-autoware-universe/autoware/src/universe/autoware.universe/perception/tensorrt_yolo/data");
  std::string engine_file = declare_parameter("engine_file", "/home/a/carla-autoware-universe/autoware/install/tensorrt_yolo/share/tensorrt_yolo/data");
  std::string label_file = declare_parameter("label_file", "/home/a/carla-autoware-universe/autoware/src/universe/autoware.universe/perception/tensorrt_yolo/data");
