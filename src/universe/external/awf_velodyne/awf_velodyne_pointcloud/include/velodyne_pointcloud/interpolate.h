...
// HH_250321 // autoware_auto_vehicle_msgs -> autoware_vehicle_msgs
...
private:
  ...
  rclcpp::Subscription<autoware_vehicle_msgs::msg::VelocityReport>::SharedPtr velocity_report_sub_; // HH_250321 // autoware_auto_vehicle_msgs -> autoware_vehicle_msgs
  ...
  std::deque<autoware_vehicle_msgs::msg::VelocityReport> velocity_report_queue_; // HH_250321 // autoware_auto_vehicle_msgs -> autoware_vehicle_msgs
