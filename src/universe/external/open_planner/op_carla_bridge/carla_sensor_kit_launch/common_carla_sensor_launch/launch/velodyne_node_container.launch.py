...
def launch_setup(context, *args, **kwargs):
    ...
    nodes.append(
        ComposableNode(
            package="autoware_pointcloud_preprocessor", # HH_250326
            plugin="autoware::pointcloud_preprocessor::CropBoxFilterComponent", # HH_250326
    ...
    nodes.append(
        ComposableNode(
            package="autoware_pointcloud_preprocessor", # HH_250326
            plugin="autoware::pointcloud_preprocessor::RingOutlierFilterComponent", # HH_250326
    ...
    container = ComposableNodeContainer(
        ...
        namespace="autoware_pointcloud_preprocessor", # HH_250326
    ...
    distortion_component = ComposableNode(
        package="autoware_pointcloud_preprocessor", # HH_250326
        plugin="autoware::pointcloud_preprocessor::DistortionCorrectorComponent", # HH_250326
